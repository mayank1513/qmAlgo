...
//*****************************************initializing G************************************************************************************
    printf("Hari!!__Memory allocation done for G");//**********************************Remove
    for(t=0;t<n;t++){
        //printf("\nG[t]=%d",G[t]);
        for(k=0;k<n;k++){
            //printf("\nG[t][k]=%d",G[t][k]);
    ...
    printf("Hari!!__Memory allocation done");
